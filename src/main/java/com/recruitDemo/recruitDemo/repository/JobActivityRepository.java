...
import com.recruitDemo.recruitDemo.entity.IRecruiterJobs;
import com.recruitDemo.recruitDemo.entity.JobActivity;
import com.recruitDemo.recruitDemo.entity.RecruiterJobsDto;
...
public interface JobActivityRepository extends JpaRepository<JobActivity,Integer> {
    ...
    List<JobActivity> searchWithoutDate(@Param("job") String job,
    ...
    List<JobActivity> search(@Param("job") String job,
                                 @Param("location") String location,
                                 @Param("remote") List<String> remote,
                                 @Param("type") List<String> type,
